...
{
    public PaymentShippingViewModel() => PaymentMethod = ShippingMethod = string.Empty;
    ...
    public bool IsEmpty() => string.IsNullOrEmpty(PaymentMethod) && string.IsNullOrEmpty(ShippingMethod);
}
