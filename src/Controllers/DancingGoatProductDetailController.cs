...
namespace DancingGoat.Controllers
{
    public class DancingGoatProductDetailController : Controller
    {
        ...
        public async Task<IActionResult> Index(CancellationToken cancellationToken)
        {
            ...
            var productItem = productPage.ProductPageProduct.FirstOrDefault();

            string? tag = productItem.ProductFieldTags.Any() ? await tagTitleRetriever.GetTagTitle(productItem.ProductFieldTags.First().Identifier, languageName, cancellationToken) : null;
