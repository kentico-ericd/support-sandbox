...
public class PromotionCouponRepository
{
    ...
    /// </summary>
    public PromotionCouponRepository(IInfoProvider<PromotionCouponInfo> promotionCouponInfoProvider) => this.promotionCouponInfoProvider = promotionCouponInfoProvider;
    ...
    {
        int promotionCouponId = await promotionCouponInfoProvider.Get()
